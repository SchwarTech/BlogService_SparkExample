...
Feature: Jeff
	...
	I can edit the web page
	I can navigate the web page

    Scenario: Verify the jeffs
      When I open the webpage with title "Foo" and content "bar"
      Then I have 1 jeffs
      Then the jeff has title "Foo"
      Then the jeff has content "bar"
